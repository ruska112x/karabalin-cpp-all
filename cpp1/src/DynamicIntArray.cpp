...
DynamicIntArray::DynamicIntArray(const DynamicIntArray &dynamicIntArray) : _size(dynamicIntArray._size),
...
DynamicIntArray::DynamicIntArray(DynamicIntArray &&dynamicIntArray) : _size(dynamicIntArray._size),
...
DynamicIntArray &DynamicIntArray::operator=(const DynamicIntArray &dynamicIntArray) {
...
DynamicIntArray &DynamicIntArray::operator=(DynamicIntArray &&dynamicIntArray) {
    if (this == &dynamicIntArray) { return *this; }
...
bool DynamicIntArray::operator==(const DynamicIntArray &dynamicIntArray) const {
    if (this == &dynamicIntArray) { return true; }
...
bool DynamicIntArray::operator<(const DynamicIntArray &dynamicIntArray) const {
    if (this == &dynamicIntArray) { return false; }
    if (_size <= dynamicIntArray._size) {
        for (int i = 0; i < _size; i++) {
            if (_array[i] >= dynamicIntArray[i]) {
                return false;
...
DynamicIntArray operator+(const DynamicIntArray &arr0, const DynamicIntArray &arr1) {
...
std::ostream &operator<<(std::ostream &out, const DynamicIntArray &dynamicIntArray) {
    for (int i = 0; i < dynamicIntArray._size; i++) {
...
int DynamicIntArray::capacity() const {
    return _buffer;
}
...
DynamicIntArray::DynamicIntArray(int size, int buffer, int n) : _size(size), _buffer(buffer) {
